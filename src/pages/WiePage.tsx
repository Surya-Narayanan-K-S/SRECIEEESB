              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="md:col-span-2 border border-slate-200 bg-white p-8 md:p-12">
                  ...
                  <p className="text-slate-600 leading-relaxed mb-6 font-medium">
                    The IEEE Women in Engineering (WIE) affinity group organizes high-impact technical symposiums, hands-on industrial workshops, and expert lectures focusing on empowerment and leadership in engineering.
                  </p>
