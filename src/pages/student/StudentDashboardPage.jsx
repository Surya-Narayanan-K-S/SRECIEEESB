...
const StudentDashboardPage = () => {
    ...
    const handleDownloadDigitalCardPng = async () => {
        ...
        try {
            ...
            link.href = dataUrl;
            link.download = `IEEE_SREC_Card_${currentUser.roll_number || currentUser.ieee_id || "member"}.png`;
            link.click();
        }
        catch (err) {
          ...
          <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-20">
            ...
            : "bg-rose-100 text-rose-800 border border-rose-300"}`}>
              ...
              <div className="w-full max-w-[540px] md:max-w-[620px] lg:max-w-[660px] mx-auto [perspective:1400px] py-1 cursor-pointer" onClick={() => setIsFlipped(!isFlipped)} title="Click card to flip in place">
                <motion.div animate={{ rotateY: isFlipped ? 180 : 0 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }} className="w-full [transform-style:preserve-3d] relative">
                  {/* CARD FRONT FACE: AUTO-ADJUSTING FLUID HIGH-TECH DESIGN */}
                  <div ref={!isFlipped ? cardRef : null} className="w-full aspect-[1.586] min-h-[220px] sm:min-h-[260px] md:min-h-[300px] lg:min-h-[330px] rounded-[20px] sm:rounded-[28px] md:rounded-[32px] bg-white text-slate-900 relative overflow-hidden shadow-[0_25px_60px_rgba(0,35,80,0.20)] border border-slate-200 select-none [backface-visibility:hidden] p-3.5 sm:p-5 md:p-6 flex flex-col justify-between">
            ...
            : "bg-[#280505] border-rose-800/80"}`}>
                  ...
                  <div ref={isFlipped ? cardRef : null} className="w-full aspect-[1.586] min-h-[220px] sm:min-h-[260px] md:min-h-[300px] lg:min-h-[330px] rounded-[20px] sm:rounded-[28px] md:rounded-[32px] bg-gradient-to-br from-[#001230] via-[#001c44] to-[#000d20] text-white absolute inset-0 select-none [transform:rotateY(180deg)] [backface-visibility:hidden] p-3.5 sm:p-5 md:p-6 flex flex-col justify-between overflow-hidden shadow-[0_25px_60px_rgba(0,35,80,0.20)] border border-blue-900/50">
