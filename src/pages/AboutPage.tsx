...
import CollegeAbout from "@/components/CollegeAbout";
import Testimonials from "@/components/Testimonials";
import { motion } from "framer-motion";
import { CalendarRange, Trophy, Globe2, Users, Rocket, Sparkles, BookOpen, Award, ShieldCheck, Target, Heart, Quote, ArrowRight } from "lucide-react";
...
const milestones = [
  ...
  },
  {
    ...
    description: "Launched specialized technical societies including Computer Society and Power & Energy Society to cater to diverse engineering disciplines.",
    icon: Globe2,
        ...
        <section className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center text-left">
          <div className="lg:col-span-7 space-y-6">
            <motion.span
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700 font-extrabold text-xs tracking-widest uppercase shadow-sm"
            >
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-6xl lg:text-7xl font-black text-slate-900 leading-none tracking-tight font-display"
            >
              About <br />
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white rounded-3xl p-5 sm:p-7 border border-slate-200/90 shadow-xl relative overflow-hidden group hover:shadow-2xl transition-all"
            >
                ...
                <div className="shrink-0">
                  {principal?.image_url ? (
                    <img
                      ...
                      className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl sm:rounded-3xl object-cover shadow-lg border-2 border-blue-600/30 shrink-0"
                    />
                  ) : (
                    <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center text-white font-black text-2xl shadow-lg border-2 border-blue-600/30 shrink-0">
                      AS
                    </div>
                  )}
                </div>
            ...
            >
              ...
              <div className="relative z-10 flex flex-row items-center gap-4 sm:gap-5">
                ...
                <div className="shrink-0">
                  <img
                    src="https://srec.ac.in/uploads/Faculty/imresizer4drkbalamurugan260715124354.jpg"
                    alt={counselor?.name || "Dr. K. Balamurugan"}
                    className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl sm:rounded-3xl object-cover shadow-lg border-2 border-indigo-600/30 shrink-0"
                  />
                </div>
              ...
              {milestones.map((item, index) => (
                <div key={index} className="relative pl-8 group">
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-md hover:shadow-xl transition-all duration-300"
                  >
            ...
            <div className="flex flex-col gap-4">
              {pillars.map((pillar, i) => (
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-md hover:shadow-xl flex items-start gap-4 group transition-all"
                >
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-md hover:shadow-xl flex flex-col justify-between min-h-[160px] group transition-all">
