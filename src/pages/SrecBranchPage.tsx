        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-12">
          ...
          >
            {activeTab === "office bearers" ? (
              <SocietyOfficeBearers societyName="IEEE SREC Student Branch" />
            ) : (
              <div className="grid md:grid-cols-3 gap-6">
                <div className="md:col-span-2 border border-slate-200 bg-white p-8 md:p-12">
                  ...
                  <p className="text-slate-600 leading-relaxed mb-6 font-medium">
                    The IEEE SREC Student Branch organizes high-impact technical symposiums, hands-on industrial workshops, and expert lectures focusing on the bleeding edge of modern engineering.
                  </p>
