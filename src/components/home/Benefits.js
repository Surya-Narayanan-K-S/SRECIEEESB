               ...
               <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                <div>
                  <Link
                    ...
                    className="group relative inline-flex items-center justify-center gap-4 px-8 py-4 rounded-full btn-gradient-ieee font-black text-xs sm:text-sm uppercase tracking-widest transition-all duration-300 shadow-xl active:scale-95 w-full sm:w-auto cursor-pointer hover:scale-105"
                  >
