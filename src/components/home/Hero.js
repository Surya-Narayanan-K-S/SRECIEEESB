...
import ArcReactorBackdrop from "@/components/ui/ArcReactorBackdrop";
    ...
    return (
      <section id="home" className="relative w-full min-h-[100svh] flex flex-col justify-center overflow-hidden bg-[#000814] selection:bg-cyan-500 selection:text-black">
        ...
        <div className="absolute inset-0 w-full h-full z-0 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#020208]/90 via-[#030611]/75 to-[#020208] z-10 pointer-events-none" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(2,2,8,0.85)_100%)] z-10 pointer-events-none" />
          
          {/* Holographic Quantum Arc-Reactor Background Engine */}
          ...
          <div className="absolute bottom-1/4 right-0 w-96 sm:w-[550px] h-96 sm:h-[550px] bg-red-600/15 rounded-full blur-[150px] pointer-events-none z-10 animate-blob animation-delay-2000" />
          <div className="absolute top-1/2 left-1/3 w-72 h-72 bg-amber-500/15 rounded-full blur-[120px] pointer-events-none z-10 animate-blob animation-delay-4000" />
        </div>
