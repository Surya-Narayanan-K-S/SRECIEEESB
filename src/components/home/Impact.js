...
const Impact = () => {
    return (<section className="py-10 md:py-12 bg-white border-t border-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 pl-0">
          {impacts.map((impact, index) => (<div key={index} className="flex flex-col items-center text-center group">
