...
const Hero = () => {
   ...
   return (
      <section id="home" className="relative w-full min-h-[100svh] flex flex-col justify-center overflow-hidden bg-[#000a18] selection:bg-cyan-500 selection:text-black">
         ...
         <div className="absolute inset-0 w-full h-full z-0 overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-[#000a18]/90 via-[#000a18]/75 to-[#000a18]/95 z-10 pointer-events-none" />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,10,24,0.6)_100%)] z-10 pointer-events-none" />
         </div>         {/* Main Hero Container */}
         <div className="relative z-20 w-full h-full flex flex-col xl:flex-row items-center xl:justify-between max-w-[1400px] mx-auto px-4 sm:px-8 xl:px-12 pt-32 sm:pt-40 pb-12 sm:pb-16">
            {/* Content Column */}
            <div className="flex flex-col items-center xl:items-start text-center xl:text-left xl:w-[58%] w-full justify-center h-full xl:h-auto pb-4 sm:pb-6">
               ...
               <div className="overflow-hidden mb-3 w-full">
                  <motion.h1
                     ...
                     className="text-[2.3rem] sm:text-5xl md:text-6xl lg:text-7xl xl:text-[6.5rem] font-extrabold text-white tracking-tight leading-[1.08] font-heading"
                  >
               ...
               <motion.div
                  ...
                  className="h-[2.5px] w-20 sm:w-32 bg-gradient-to-r from-cyan-400 via-blue-500 to-transparent my-3 sm:my-4 origin-left xl:self-start self-center rounded-full"
               />
               ...
               <motion.p
                  ...
                  className="text-slate-200/90 text-xs sm:text-base md:text-lg leading-relaxed mb-6 sm:mb-8 max-w-xl font-normal"
               >
               ...
               >
                  ...
                  <a
                     ...
                     className="w-full sm:w-auto flex items-center justify-center gap-2 px-7 py-3.5 sm:py-4 rounded-full bg-white/10 hover:bg-white/18 border border-white/25 text-white font-bold text-xs sm:text-sm tracking-widest uppercase transition-all duration-300 backdrop-blur-md active:scale-95 hover:border-cyan-400/50"
                  >
                     Join IEEE
                  </a>
               </motion.div>
            ...
            <motion.div
               ...
               className="flex flex-col w-full xl:w-[40%] bg-[#00122a]/85 backdrop-blur-2xl border border-cyan-500/35 rounded-3xl p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,10,25,0.8)] relative overflow-hidden group shrink-0 mt-10 xl:mt-0"
            >
               ...
               <div className="relative z-10 flex flex-col gap-5">
                  <div className="text-left">
                     <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-cyan-500/20 text-cyan-300 font-semibold text-xs tracking-wider uppercase border border-cyan-500/30 mb-3">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-2.5">
                     {[
                        ...
                        <div
                           key={i}
                           className="py-3 px-1.5 rounded-2xl bg-[#000a18]/90 border border-cyan-500/30 backdrop-blur-md text-center shadow-lg hover:border-cyan-400/60 transition-all flex flex-col items-center justify-center min-w-0"
                        >
