...
export const DownloadAppModal: React.FC<DownloadAppModalProps> = ({
  ...
  const [selectedPlatform, setSelectedPlatform] = useState<"android" | "samsung" | "pwa" | "ios">("android");
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/80 backdrop-blur-md overflow-y-auto">
        <motion.div
          ...
          className="relative w-full max-w-lg rounded-3xl bg-[#001026] border border-cyan-500/40 p-5 sm:p-6 shadow-[0_25px_80px_rgba(0,0,0,0.85)] text-slate-100 space-y-4 my-auto overflow-hidden"
        >
          {/* Ambient Glows */}
            ...
            >
              ...
              <div className="flex gap-2 pt-1">
                <button
                  ...
                  className="flex-1 py-3 rounded-2xl bg-gradient-to-r from-cyan-400 via-sky-400 to-blue-500 hover:from-cyan-300 hover:to-blue-400 text-slate-950 font-black text-xs uppercase tracking-wider shadow-[0_0_25px_rgba(0,210,255,0.4)] flex items-center justify-center gap-2 active:scale-95 transition-all"
                >
                  <Download size={16} />
          ...
          {selectedPlatform === "samsung" && (
            ...
            >
              ...
              <a
                href="https://galaxystore.samsung.com/detail/com.srecieee.app"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full py-3 rounded-2xl bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-400 hover:to-indigo-500 text-white font-black text-xs uppercase tracking-wider shadow-lg flex items-center justify-center gap-2 active:scale-95 transition-all"
              >
          ...
          {selectedPlatform === "pwa" && (
            ...
            >
              ...
              <a
                href="/app"
                className="w-full py-3 rounded-2xl bg-gradient-to-r from-cyan-400 to-blue-500 text-slate-950 font-black text-xs uppercase tracking-wider shadow-md flex items-center justify-center gap-2 active:scale-95 transition-all text-center"
              >
          ...
          {selectedPlatform === "ios" && (
            ...
            >
              ...
              <button
                ...
                className="w-full py-3 rounded-2xl bg-slate-800 hover:bg-slate-700 border border-slate-600 text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 active:scale-95 transition-all"
              >
