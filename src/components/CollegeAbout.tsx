...
const CollegeAbout = () => {
  ...
  return (
    <section id="college" className="py-8 sm:py-16 md:py-24 scroll-mt-24 relative overflow-hidden bg-slate-50/50">
          ...
          <div className="lg:col-span-5 flex flex-col justify-stretch">
            <div className="relative aspect-square sm:aspect-[4/5] lg:aspect-square bg-slate-900 rounded-2xl sm:rounded-3xl border border-slate-200/90 shadow-xl overflow-hidden group text-center min-h-[300px] sm:min-h-[440px]">
              ...
              <motion.div
                ...
                style={{ backgroundImage: `url(${srecCampus})` }}
              />
              ...
              <div className="relative z-20 h-full p-4 sm:p-8 flex flex-col justify-between items-center text-center">
                ...
                <div className="my-auto flex flex-col items-center">
                  <motion.div
                    ...
                    className="mb-3 sm:mb-6 p-2 sm:p-3 rounded-xl sm:rounded-2xl bg-white/90 backdrop-blur-md border border-white shadow-2xl"
                  >
                    <img 
                      src={srecLogo} 
                      alt="SREC Emblem" 
                      className="h-16 sm:h-28 md:h-32 object-contain" 
                    />
                  </motion.div>
            ...
            {features.map((f) => {
              ...
              return (
                <div 
                  ...
                  className={`p-4 sm:p-7 rounded-xl sm:rounded-3xl border transition-all duration-300 ease-out cursor-pointer flex gap-3.5 sm:gap-6 relative overflow-hidden ${
                    isHovered 
                ...
                >
                  ...
                  <div className={`absolute left-0 top-0 bottom-0 w-[3px] sm:w-[4px] bg-gradient-to-b ${f.color} transition-transform duration-300 ${
                    isHovered ? 'scale-y-100' : 'scale-y-0'
                  }`} />

                  <div className={`w-9 h-9 sm:w-12 sm:h-12 rounded-lg sm:rounded-2xl flex items-center justify-center shrink-0 border transition-all duration-300 ${
                  ...
                  <div className="flex-1">
                    <h3 className={`text-sm sm:text-lg font-bold mb-1 sm:mb-2 transition-colors duration-300 ${
                      isHovered ? 'text-blue-600' : 'text-slate-800'
                    }`}>
                      {f.title}
                    </h3>
                    <p className={`text-[11px] sm:text-sm leading-relaxed transition-all duration-300 ${
