    ...
    <form onSubmit={handleSubmit} className="rounded-3xl bg-[#0b0b0f] border border-amber-500/25 p-8 shadow-2xl relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2">
          <label className="block text-xs font-bold text-amber-400/90 uppercase mb-2 items-center gap-1.5">
        ...
        <div className="md:col-span-2">
          ...
          {form.image_url && (<p className="text-[11px] text-amber-400 font-mono mt-1.5 truncate">
            ✓ URL: {form.image_url}
          </p>)}
        </div>
      </div>
            ...
            <table className="w-full text-left border-collapse text-xs">
              ...
              <tbody className="divide-y divide-zinc-800/60 font-medium text-zinc-300">
                {filteredBearers.length === 0 ? (<tr>
                  <td colSpan={7} className="py-10 text-center text-zinc-500 font-semibold">
