...
export const EventReportsPage = () => {
    ...
    return (
      <div className="min-h-screen bg-white text-slate-900 flex flex-col font-sans selection:bg-blue-600 selection:text-white relative overflow-x-hidden">
        {/* ─── AMBIENT ARCHITECTURAL MESH ─── */}
        <div className="pointer-events-none absolute inset-0 overflow-hidden select-none -z-0">
          <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,102,204,0.03)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,102,204,0.03)_1px,transparent_1px)] bg-[size:32px_32px]" />
          <div className="absolute -top-32 -left-20 w-[600px] h-[600px] bg-blue-500/5 rounded-full blur-[160px]"/>
          <div className="absolute top-1/3 -right-20 w-[550px] h-[550px] bg-sky-500/5 rounded-full blur-[160px]"/>
        </div>
