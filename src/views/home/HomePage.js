...
// Subtle Parallax Block for moving objects effect (Crisp Clean Architectural White Theme)
const MovingParallaxBackdrop = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[-1] overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,102,204,0.03)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,102,204,0.03)_1px,transparent_1px)] bg-[size:48px_48px] pointer-events-none" />
      
      {/* Soft Ambient Flares */}
      <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-blue-400/5 rounded-full blur-[160px] pointer-events-none" />
      <div className="absolute top-2/3 right-1/4 w-[550px] h-[550px] bg-sky-400/5 rounded-full blur-[150px] pointer-events-none" />

      <motion.div style={{ y: yOffset }} className="absolute inset-0 opacity-[0.02]">
        <div className="absolute top-[20%] -left-[10%] text-[20vw] font-black uppercase whitespace-nowrap leading-none text-slate-900 tracking-tighter font-display">
          INNOVATION
        </div>
        <div className="absolute top-[60%] -right-[5%] text-[15vw] font-black uppercase whitespace-nowrap leading-none text-blue-900 tracking-tighter font-display">
          EXCELLENCE
        </div>
      </motion.div>
    </div>
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen relative selection:bg-blue-600 selection:text-white font-sans text-slate-800 bg-white">
            ...
            <div className="max-w-[1400px] mx-auto px-6 py-12 md:py-16 text-center">
              <FadeInSection>
                <div className="max-w-2xl mx-auto flex flex-col items-center">
                  ...
                  <a
                    href="/contact"
                    className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full btn-gradient-ieee font-bold text-sm transition-all shadow-lg active:scale-95 hover:scale-105"
                  >
