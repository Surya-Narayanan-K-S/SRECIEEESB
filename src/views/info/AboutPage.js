...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 relative overflow-hidden font-sans selection:bg-blue-600 selection:text-white">

      {/* Clean Ambient Background Pattern */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,102,204,0.03)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,102,204,0.03)_1px,transparent_1px)] bg-[size:32px_32px] pointer-events-none z-0" />
      <div className="absolute top-1/4 left-0 w-[550px] h-[550px] bg-blue-400/8 rounded-full blur-[160px] pointer-events-none -translate-x-1/2" />
      <div className="absolute top-3/4 right-0 w-[600px] h-[600px] bg-indigo-400/8 rounded-full blur-[160px] pointer-events-none translate-x-1/3" />
        ...
        <section className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center text-left">
          <div className="lg:col-span-7 space-y-6">
            <motion.span initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700 font-extrabold text-xs tracking-widest uppercase shadow-sm">
              ...
              <span>DISCOVER OUR LEGACY • EST. 2001</span>
            </motion.span>
            ...
            <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-4xl sm:text-6xl lg:text-7xl font-black text-slate-900 leading-none tracking-tight font-display">
              About <br />
              <span className="bg-gradient-to-r from-[#002855] via-blue-700 to-indigo-900 bg-clip-text text-transparent not-italic font-black">
                SREC IEEE SB
              </span>
            </motion.h1>
            ...
            <div className="grid sm:grid-cols-3 gap-4 pt-4">
              {[
                ...
                <div key={i} className="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md transition-all">
