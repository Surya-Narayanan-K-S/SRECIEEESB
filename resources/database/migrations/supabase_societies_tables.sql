-- ==============================================================================
-- IEEE SREC - ALL PAGES & ALL SOCIETIES MASTER DATABASE SCRIPT
-- ==============================================================================
...
-- ─── 3. STUDENT MEMBERS ROSTER TABLE ───
...
-- ─── 4. ACTIVITIES, AWARDS, PLANS, SENIOR MEMBERS & FUNDING ───
...
-- ─── 5. DEDICATED INDIVIDUAL SOCIETY TABLES ───

-- 1. SREC STUDENT BRANCH
...
BEGIN
    FOR tbl IN
        ...
        AND tablename IN (
            'page_contents', 'page_content', 'societies', 'student_members',
            'activities', 'awards', 'annual_plans', 'senior_members', 'funding_submissions',
...
-- ==============================================================================
-- 7. INSERT REAL CONTENT FOR ALL PAGES
-- ==============================================================================
...
-- ─── 4. SOCIETIES HUB PAGE ───
INSERT INTO public.page_contents (page_key, content_key, content_text) VALUES
('societies', 'societies_hero_badge', 'IEEE SREC Technical Affiliations'),
('societies', 'societies_hero_title', 'Specialized Technical Societies & Chapters'),
('societies', 'societies_hero_subtitle', 'Explore SREC''s 8 specialized IEEE technical societies and student branch wings. Engage in global hackathons, cutting-edge research symposiums, industry certifications, and leadership roles.'),
('societies', 'societies_cta_badge', 'Join IEEE SREC Student Branch'),
('societies', 'societies_cta_title', 'Ready to Accelerate Your Engineering Career?'),
('societies', 'societies_cta_subtitle', 'Join 500+ student engineers at SREC. Get access to IEEE Xplore digital library, global society memberships, technical workshops, paper publications, and leadership credentials.')
ON CONFLICT (content_key) DO UPDATE SET content_text = EXCLUDED.content_text, updated_at = NOW();

-- ─── 5. MEMBERSHIP REGISTRATION PAGE ───
INSERT INTO public.page_contents (page_key, content_key, content_text) VALUES
...
-- ==============================================================================
-- 8. INSERT SOCIETIES MASTER METADATA
-- ==============================================================================
INSERT INTO public.societies (id, name, short_code, tagline, description, established_year, member_count) VALUES
(1, 'IEEE SREC Student Branch', 'IEEE SB', 'The Core Umbrella of Student Leadership & Global Tech Initiatives', 'The overarching student branch connecting all technical chapters, hosting flagship hackathons, symposiums, and professional growth opportunities at SREC.', 2001, 150),
(2, 'IEEE Computer Society (CS)', 'CS', 'Computing, Cloud Architecture, Artificial Intelligence & Software Systems', 'The premier global source for information, inspiration, and collaboration in computer science, algorithm design, cybersecurity, and emerging software paradigms.', 2005, 80),
(3, 'IEEE Power Electronics Society (PELS)', 'PELS', 'Power Systems, Electric Mobility, Inverters & Renewable Grids', 'Advancing power electronics, clean energy conversion, electric vehicles, microgrids, motor drives, and next-generation energy storage solutions.', 2012, 75),
(4, 'IEEE Computational Intelligence Society (CIS)', 'CIS', 'Neural Networks, Deep Learning & Evolutionary Artificial Intelligence', 'Pioneering research and applications in biological neural modeling, fuzzy logic systems, evolutionary computing, and nature-inspired intelligent architectures.', 2018, 50),
(5, 'IEEE Communications Society (ComSoc)', 'ComSoc', '5G/6G Networks, Optical Fiber & Wireless Telecommunications', 'Nurturing innovation in telecommunications, next-gen mobile networks, optical communications, internet-of-things protocols, and global connectivity.', 2014, 55),
(6, 'IEEE Engineering in Medicine & Biology Society (EMBS)', 'EMBS', 'Medical Technology, Neural Engineering, Biosensors & Digital Healthcare', 'Integrating engineering with medicine and biology to enhance healthcare diagnostics, robotic prosthetics, medical imaging, and biosensor technology.', 2016, 45),
(7, 'IEEE Women in Engineering (WIE)', 'WIE', 'Empowering Women Leaders, Researchers & Innovators Worldwide', 'Dedicated to promoting female engineers, scientists, and researchers, inspiring girls around the world to pursue academic and professional STEM excellence.', 2008, 90),
(8, 'IEEE Circuits and Systems Society (CAS)', 'CAS', 'VLSI Microchips, Analog/Digital Silicon & Hardware AI Accelerators', 'Advancing the theory, design, and practical fabrication of microelectronic circuits, custom VLSI chips, signal processors, and neural hardware accelerators.', 2020, 40),
(9, 'IEEE Instrumentation & Measurement Society (IMS)', 'IMS', 'Precision Measurement, Automated Sensor Systems & Calibration', 'Dedicated to measurement science, automated sensor networks, precision data acquisition, high-fidelity testing instrumentation, and standards calibration.', 2017, 35)
ON CONFLICT (name) DO UPDATE 
SET short_code = EXCLUDED.short_code, tagline = EXCLUDED.tagline, description = EXCLUDED.description;


-- ==============================================================================
-- 9. INSERT REAL STUDENT DATABASE ROSTER RECORDS
-- ==============================================================================
...
-- ==============================================================================
-- 10. INSERT REAL LEADERSHIP DATA FOR ALL 9 CHAPTERS
-- ==============================================================================

-- 1. SREC STUDENT BRANCH
INSERT INTO public.srec_office_bearers (name, role, department, academic_year, image_url) VALUES
('Dr.K.Balamurugan', 'Student Branch Counsellor', 'AsP/EEE', '2024-2026', 'https://srec.ac.in/uploads/Faculty/imresizer4drkbalamurugan260715124354.jpg'),
('S Darshan', 'Chairperson', 'IV EEE', '2024-2026', NULL),
('D Jennifer Shobha', 'Vice-Chairperson', 'III Civil', '2024-2026', NULL),
('R Vishnu Kaarthik', 'Secretary', 'III EEE', '2024-2026', NULL),
('D R Prithika', 'Treasurer', 'II EEE B', '2024-2026', NULL),
('S Deepak', 'Activities Coordinator', 'IV EEE', '2024-2026', NULL),
('S Amirtha Varshini', 'Joint Activity Coordinator', 'III CSE A', '2024-2026', NULL),
('V Smrthikha', 'Joint Activity Coordinator', 'III BME', '2024-2026', NULL),
('K S Surya Narayanan', 'Webmaster', 'II EEE B', '2024-2026', NULL),
('Nithin Annamalai R', 'Editor', 'II EEE B', '2024-2026', NULL),
('S Latisha', 'Editor', 'III CSE B', '2024-2026', NULL),
('Dharshini', 'Editor', 'III IT A', '2024-2026', NULL)
ON CONFLICT DO NOTHING;

INSERT INTO public.srec_executive_members (name, role, department, academic_year) VALUES
('S Mathusri', 'Executive Lead', 'III M.Tech CSE', '2024-2026'),
('D Akshaya Dharun', 'Technical Executive', 'II CSE A', '2024-2026'),
('A Dhivya Tharsana', 'Creative Executive', 'II AI & DS', '2024-2026'),
('S V Hemesh', 'Operations Executive', 'II CSE A', '2024-2026'),
('M Barath', 'Events Executive', 'II EEE A', '2024-2026'),
('F Mohammed Aathif F', 'Social Media Executive', 'II EEE A', '2024-2026'),
('Bhargavan Balaji', 'Executive Member', 'II EEE A', '2024-2026'),
('R Srenithi', 'Executive Member', 'III M.Tech CSE', '2024-2026'),
('V Swetha', 'Executive Member', 'III EIE', '2024-2026')
ON CONFLICT DO NOTHING;

-- 2. IEEE PELS
INSERT INTO public.pels_office_bearers (name, role, department, academic_year, linkedin_url) VALUES
('Pabitra Santra', 'Chairperson', 'III EEE', '2026-2027', 'https://srecieee.org/membership-registration'),
('Jeevith Pranav P', 'Vice Chairperson', 'IV EEE A', '2026-2027', NULL),
('Vaibhavi M', 'Treasurer', 'II EEE B', '2026-2027', NULL),
('Gowri Priya Vadana A', 'Activity Coordinator', 'II EEE A', '2026-2027', NULL),
('Alexander Samuel R', 'Activity Coordinator', 'II EEE A', '2026-2027', NULL),
('Swathi P', 'Social Media', 'II EEE B', '2026-2027', NULL),
('Sabarinath V S B', 'Social Media', 'II EEE B', '2026-2027', NULL)
ON CONFLICT DO NOTHING;

INSERT INTO public.pels_executive_members (name, role, department, academic_year) VALUES
('Kishore Kumar J', 'Executive Member', 'II EEE A', '2026-2027'),
('Hari Sarran M', 'Executive Member', 'II EEE A', '2026-2027'),
('Ishani S', 'Executive Member', 'II EEE A', '2026-2027'),
('Arya M S', 'Executive Member', 'II EEE A', '2026-2027'),
('Kavipriya K', 'Executive Member', 'II EEE A', '2026-2027'),
('Nikhil Balaji R', 'Executive Member', 'II EEE B', '2026-2027'),
('Ranjith Kumar R', 'Executive Member', 'II EEE B', '2026-2027'),
('Vishweshwaran G', 'Executive Member', 'II EEE B', '2026-2027'),
('Janani A P', 'Executive Member', 'II EEE A', '2026-2027'),
('Divya Dharshini N', 'Executive Member', 'II EEE A', '2026-2027')
ON CONFLICT DO NOTHING;

-- 3. IEEE CS
INSERT INTO public.cs_office_bearers (name, role, department, academic_year) VALUES
('S Mathusri', 'Chairperson', 'III M.Tech CSE', '2024-2026'),
('D Akshaya Dharun', 'Vice Chairperson', 'II CSE A', '2024-2026'),
('S V Hemesh', 'Secretary', 'II CSE A', '2024-2026'),
('S Amirtha Varshini', 'Treasurer', 'III CSE A', '2024-2026'),
('S Latisha', 'Editor', 'III CSE B', '2024-2026'),
('Dharshini', 'Technical Head', 'III IT A', '2024-2026')
ON CONFLICT DO NOTHING;

INSERT INTO public.cs_executive_members (name, role, department, academic_year) VALUES
('A Dhivya Tharsana', 'Creative Executive', 'II AI & DS', '2024-2026'),
('K S Surya Narayanan', 'Webmaster', 'II EEE B', '2024-2026'),
('R Srenithi', 'Executive Member', 'III M.Tech CSE', '2024-2026'),
('F Mohammed Aathif F', 'Executive Member', 'II EEE A', '2024-2026')
ON CONFLICT DO NOTHING;

-- 4. IEEE WIE
INSERT INTO public.wie_office_bearers (name, role, department, academic_year) VALUES
('Mrs. S. Jansi Rani', 'IEEE WIE Coordinator', 'AP(Sr.G)/IT', '2024-2026'),
('S Kaniska Sri', 'Chairperson', 'II EEE A', '2024-2026'),
('S Karishma', 'Vice-Chairperson', 'IV BME', '2024-2026'),
('K Muthtamil', 'Secretary', 'III ECE', '2024-2026'),
('D R Prithika', 'Treasurer', 'II EEE B', '2024-2026'),
('V Smrthikha', 'Joint Activity Coordinator', 'III BME', '2024-2026')
ON CONFLICT DO NOTHING;

INSERT INTO public.wie_executive_members (name, role, department, academic_year) VALUES
('S Amirtha Varshini', 'Executive Member', 'III CSE A', '2024-2026'),
('A Dhivya Tharsana', 'Creative Lead', 'II AI & DS', '2024-2026'),
('D Jennifer Shobha', 'Executive Member', 'III Civil', '2024-2026'),
('S Mathusri', 'Technical Executive', 'III M.Tech CSE', '2024-2026'),
('R Srenithi', 'Executive Member', 'III M.Tech CSE', '2024-2026'),
('V Swetha', 'Executive Member', 'III EIE', '2024-2026')
ON CONFLICT DO NOTHING;

-- 5. IEEE CAS
INSERT INTO public.cas_office_bearers (name, role, department, academic_year) VALUES
('K S Surya Narayanan', 'Chairperson', 'II EEE B', '2024-2026'),
('Vaibhavi Manoharan', 'Vice Chairperson', 'II EEE B', '2024-2026'),
('Swathi P', 'Secretary', 'II EEE B', '2024-2026'),
('Nithin Annamalai R', 'Treasurer', 'II EEE B', '2024-2026')
ON CONFLICT DO NOTHING;

INSERT INTO public.cas_executive_members (name, role, department, academic_year) VALUES
('M Barath', 'VLSI Design Lead', 'II EEE A', '2024-2026'),
('F Mohammed Aathif F', 'Hardware Executive', 'II EEE A', '2024-2026'),
('Bhargavan Balaji', 'Technical Member', 'II EEE A', '2024-2026')
ON CONFLICT DO NOTHING;

-- 6. IEEE CIS
INSERT INTO public.cis_office_bearers (name, role, department, academic_year) VALUES
('A Dhivya Tharsana', 'Chairperson', 'II AI & DS', '2024-2026'),
('D Akshaya Dharun', 'Vice Chairperson', 'II CSE A', '2024-2026'),
('S V Hemesh', 'Secretary', 'II CSE A', '2024-2026'),
('S Mathusri', 'Treasurer', 'III M.Tech CSE', '2024-2026')
ON CONFLICT DO NOTHING;

INSERT INTO public.cis_executive_members (name, role, department, academic_year) VALUES
('R Srenithi', 'AI Research Lead', 'III M.Tech CSE', '2024-2026'),
('S Latisha', 'Deep Learning Executive', 'III CSE B', '2024-2026')
ON CONFLICT DO NOTHING;

-- 7. IEEE ComSoc
INSERT INTO public.comsoc_office_bearers (name, role, department, academic_year) VALUES
('K Muthtamil', 'Chairperson', 'III ECE', '2024-2026'),
('M Barath', 'Vice Chairperson', 'II EEE A', '2024-2026'),
('F Mohammed Aathif F', 'Secretary', 'II EEE A', '2024-2026')
ON CONFLICT DO NOTHING;

INSERT INTO public.comsoc_executive_members (name, role, department, academic_year) VALUES
('Alexander Samuel R', 'Telecom Executive', 'II EEE A', '2024-2026'),
('Gowri Priya Vadana A', '5G Wireless Executive', 'II EEE A', '2024-2026')
ON CONFLICT DO NOTHING;

-- 8. IEEE EMBS
INSERT INTO public.embs_office_bearers (name, role, department, academic_year) VALUES
('S Karishma', 'Chairperson', 'IV BME', '2024-2026'),
('V Smrthikha', 'Vice Chairperson', 'III BME', '2024-2026'),
('Lavanya S', 'Secretary', 'III Civil', '2024-2026')
ON CONFLICT DO NOTHING;

INSERT INTO public.embs_executive_members (name, role, department, academic_year) VALUES
('Swetha V', 'Bio-Medical Executive', 'III EIE', '2024-2026'),
('Ishani S', 'Healthcare Technology Executive', 'II EEE A', '2024-2026')
ON CONFLICT DO NOTHING;

-- 9. IEEE IMS
INSERT INTO public.im_office_bearers (name, role, department, academic_year) VALUES
('V Swetha', 'Chairperson', 'III EIE', '2024-2026'),
('S Deepak', 'Vice Chairperson', 'IV EEE', '2024-2026'),
('D Jennifer Shobha', 'Secretary', 'III Civil', '2024-2026')
ON CONFLICT DO NOTHING;

INSERT INTO public.im_executive_members (name, role, department, academic_year) VALUES
('Bhargavan Balaji', 'Instrumentation Lead', 'II EEE A', '2024-2026'),
('Kishore Kumar J', 'Sensors Executive', 'II EEE A', '2024-2026')
ON CONFLICT DO NOTHING;


-- ==============================================================================
-- 11. INSERT REAL ACTIVITIES & SYMPOSIA
-- ==============================================================================
...
-- ==============================================================================
-- 13. INSERT REAL ANNUAL PLANS & ROADMAP
-- ==============================================================================
...
-- ==============================================================================
-- 14. INSERT REAL SENIOR MEMBERS & FACULTY MENTORS
-- ==============================================================================
